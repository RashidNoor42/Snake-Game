...
pygame.mixer.music.load("bensound-adventure.mp3")
...
def game_loop():
    ...
    while running:
        ...
        game_display.fill(background_color)
        # Draw
        pygame.draw.rect(game_display, apple_img_rect, [rand_apple_x, rand_apple_y, block_size, block_size])
        game_display.blit(apple_img,(rand_apple_x-3, rand_apple_y-8))
